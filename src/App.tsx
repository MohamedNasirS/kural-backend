...
import { SurveyMasterDataMapper } from "@/pages/l0/SurveyMasterDataMapper";
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/l0/survey-master-data-mapper" element={<ProtectedRoute allowedRoles={['L0']}><SurveyMasterDataMapper /></ProtectedRoute>} />
