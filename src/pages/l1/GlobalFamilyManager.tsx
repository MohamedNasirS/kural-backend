...
import { Search, Filter, Home, Users, Loader2 } from 'lucide-react';
...
export const GlobalFamilyManager = () => {
  ...
  }, [selectedAC, boothFilter, pagination.page]);
  ...
  const fetchFamilies = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/families/${selectedAC}?${params}`, {
        credentials: 'include',
      });
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            View and manage families across all Assembly Constituencies
          </p>
        </div>
            ...
            <div className="flex-1">
              ...
              <Select value={selectedAC} onValueChange={setSelectedAC}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select an AC to view families" />
                </SelectTrigger>
                <SelectContent>
        ...
        {selectedAC ? (
          ...
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground">Choose an AC from the dropdown above to view and manage families</p>
          </Card>
        )}
      </div>
